...
# -*- coding: utf-8 -*-
# PyXB bindings for NM:ec9034ce91bd95aa267fb88791d4d89b807adeb6
# Generated 2017-10-20 11:46:28.948522 by PyXB version 1.2.5 using Python 3.6.1.final.0
# Namespace http://www.chargebackDocument.com/schema
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:d64c4492-b5ad-11e7-bd8e-001a4a010721')
...
Namespace = pyxb.namespace.NamespaceForURI('http://www.chargebackDocument.com/schema', create_if_missing=True)
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.chargebackDocument.com/schema}ResponseCode uses Python identifier ResponseCode
    __ResponseCode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ResponseCode'), 'ResponseCode', '__httpwww_chargebackDocument_comschema_CTD_ANON_httpwww_chargebackDocument_comschemaResponseCode', False, pyxb.utils.utility.Location('/usr/local/litle-home/rchabhad/git/cnp-chargeback-sdk-python/schema/litleChargebackWebService_v1.0.xsd', 5, 12), )

    
    ResponseCode = property(__ResponseCode.value, __ResponseCode.set, None, None)

    
    # Element {http://www.chargebackDocument.com/schema}ResponseMessage uses Python identifier ResponseMessage
    __ResponseMessage = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ResponseMessage'), 'ResponseMessage', '__httpwww_chargebackDocument_comschema_CTD_ANON_httpwww_chargebackDocument_comschemaResponseMessage', False, pyxb.utils.utility.Location('/usr/local/litle-home/rchabhad/git/cnp-chargeback-sdk-python/schema/litleChargebackWebService_v1.0.xsd', 6, 12), )
    ...
    __id = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'id'), 'id', '__httpwww_chargebackDocument_comschema_CTD_ANON_id', pyxb.binding.datatypes.string, required=True)
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.chargebackDocument.com/schema}ChargebackCase uses Python identifier ChargebackCase
    __ChargebackCase = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ChargebackCase'), 'ChargebackCase', '__httpwww_chargebackDocument_comschema_CTD_ANON__httpwww_chargebackDocument_comschemaChargebackCase', False, pyxb.utils.utility.Location('/usr/local/litle-home/rchabhad/git/cnp-chargeback-sdk-python/schema/litleChargebackWebService_v1.0.xsd', 26, 4), )
    ...
    # Attribute id uses Python identifier id
    __id = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'id'), 'id', '__httpwww_chargebackDocument_comschema_CTD_ANON__id', pyxb.binding.datatypes.string, required=True)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.chargebackDocument.com/schema}ResponseCode uses Python identifier ResponseCode
    __ResponseCode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ResponseCode'), 'ResponseCode', '__httpwww_chargebackDocument_comschema_CTD_ANON_2_httpwww_chargebackDocument_comschemaResponseCode', False, pyxb.utils.utility.Location('/usr/local/litle-home/rchabhad/git/cnp-chargeback-sdk-python/schema/litleChargebackWebService_v1.0.xsd', 5, 12), )
    ...
    # Element {http://www.chargebackDocument.com/schema}ResponseMessage uses Python identifier ResponseMessage
    __ResponseMessage = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ResponseMessage'), 'ResponseMessage', '__httpwww_chargebackDocument_comschema_CTD_ANON_2_httpwww_chargebackDocument_comschemaResponseMessage', False, pyxb.utils.utility.Location('/usr/local/litle-home/rchabhad/git/cnp-chargeback-sdk-python/schema/litleChargebackWebService_v1.0.xsd', 6, 12), )

    
    ResponseMessage = property(__ResponseMessage.value, __ResponseMessage.set, None, None)

    
    # Element {http://www.chargebackDocument.com/schema}Document uses Python identifier Document
    __Document = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Document'), 'Document', '__httpwww_chargebackDocument_comschema_CTD_ANON_2_httpwww_chargebackDocument_comschemaDocument', False, pyxb.utils.utility.Location('/usr/local/litle-home/rchabhad/git/cnp-chargeback-sdk-python/schema/litleChargebackWebService_v1.0.xsd', 10, 4), )

    
    Document = property(__Document.value, __Document.set, None, None)

    
    # Element {http://www.chargebackDocument.com/schema}DocumentEntry uses Python identifier DocumentEntry
    __DocumentEntry = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'DocumentEntry'), 'DocumentEntry', '__httpwww_chargebackDocument_comschema_CTD_ANON_2_httpwww_chargebackDocument_comschemaDocumentEntry', True, pyxb.utils.utility.Location('/usr/local/litle-home/rchabhad/git/cnp-chargeback-sdk-python/schema/litleChargebackWebService_v1.0.xsd', 30, 16), )
    ...
    # Attribute id uses Python identifier id
    __id = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'id'), 'id', '__httpwww_chargebackDocument_comschema_CTD_ANON_2_id', pyxb.binding.datatypes.string, required=True)
...
class CTD_ANON_3 (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute id uses Python identifier id
    __id = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'id'), 'id', '__httpwww_chargebackDocument_comschema_CTD_ANON_3_id', pyxb.binding.datatypes.string, required=True)
